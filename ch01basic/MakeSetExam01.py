...
print('%s 존재 여부 : %s' % (targetItem, bool))  ## True False 도 %s??.. ㄷㄷ

targetItem = '마키야또'
if targetItem not in coffees:
...
coffee01 = {'고구마라떼', '에스프레소', '아메리카노', '마키야또'}
...
super_shy = {'고구마라떼', '에스프레소', '아메리카노', '마키야또'}
sub_set_01 = {'고구마라떼', '에스프레소'}
sub_set_02 = {'바닐라라떼', '마키야또'}

boolTest = sub_set_01.issubset(super_shy)
if boolTest:
    print('집합01은 슈퍼 집합의 부분 집합입니다.')
else:
    print('집합01은 슈퍼 집합의 부분 집합이 아닙니다.')

boolTest = super_shy.issuperset(sub_set_02)
if boolTest :
    print('super_shy는 sub_set_02의 상위 집합입니다.')
else:
    print('super_shy는 sub_set_02의 상위 집합이 아닙니다.')